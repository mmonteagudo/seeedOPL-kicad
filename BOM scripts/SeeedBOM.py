...
#columns = ['References'] + sorted(list(columnset)) + ['Qty']
columns = ['References','MPN/Seeed SKU','Qty']
...
for group in grouped:
    ...
    #if no MPN is found use the Seeed SKU instead
    val = net.getGroupField(group, "MPN")
    if len(val)==0:
        val = net.getGroupField(group, "SKU")
    
    row.append(val)

    #Add the quantity of references
